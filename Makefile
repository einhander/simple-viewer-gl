...
clean:
	rm -fr $(BUILD_DIR)* $(OUT_NAME) $(BUNDLE_NAME) \
...
dist:   clean
	...
	cp -R cmake src res third-party dist/debian INSTALL README.md Copying.txt CMakeLists.txt Makefile sviewgl.desktop dist/fedora/* dist/gentoo/* $(BUNDLE_NAME)-$(VERSION)
